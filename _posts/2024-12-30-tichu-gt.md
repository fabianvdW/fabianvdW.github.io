...
$ E(\text{relativer Rundengewinn} | \text{k' unter ersten 14, Spieler hat kein GT angesagt}) $. In der zweiten und vierten Spalte sind alle "korrigierten" Werte fett markiert.

Die Opportunitätskosten 1. - 2. folgen in einer zweiten Tabelle.
